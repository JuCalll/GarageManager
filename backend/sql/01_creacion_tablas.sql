-- =============================================================================
-- Garage Manager — Script de creación de tablas (solo DDL)
-- Motor: MySQL 8 / MariaDB (XAMPP u otro)
-- Uso: ejecutar contra un servidor MySQL. Crea la base y todas las tablas.
--      Para datos de prueba, ejecute después: 02_datos_prueba.sql
-- =============================================================================
